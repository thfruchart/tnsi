...
3. j’ajoute immédiatement les jointures sans réfléchir, à savoir `ON  table2.clefEtrangere = table1.clefPrimaire`
...
Pour chacune des questions ci-dessous, écrire **une** requête SQL dans le [notebook suivant](https://notebook.basthon.fr/?kernel=sql&from=https://raw.githubusercontent.com/thfruchart/src-tnsi/main/02/ZOO.ipynb)
