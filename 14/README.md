...
## Liens à explorer
1. [Aspects historiques](http://www.monlyceenumerique.fr/nsi_terminale/lp/lp1_calculabilite_decidabilite.php)
2. [Machine de Turing](https://naereen.github.io/jsTuring_fr/turing.html)
...
4. Notebook sur le [problème de l'arrêt](https://github.com/thfruchart/tnsi/blob/main/14/Pb_ARRET.ipynb)
